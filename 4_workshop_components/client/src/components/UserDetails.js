...
export const UserDetails = ({ _id, firstName, lastName, email, imageUrl, phoneNumber, address, createdAt, updatedAt, onClose }) => {
    return (
                ...
                <div className="detail-container">
                    ...
                    <div className="content">
                        <div className="image-container">
                            <img src={imageUrl} alt={`${firstName} ${lastName} profile`} className="image" />
                        </div>
