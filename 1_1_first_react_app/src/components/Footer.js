    ...
    <div className="container-fluid footer">
      <div className="row contact">
          ...
          <form className="form-horizontal" data-toggle="validator" role="form">
            ...
            <div className="form-group">
              <div className="col-sm-offset-3 col-sm-9">
                <button type="submit" id="submit" name="submit" className="btn btn-yellow pull-right">
        ...
        <div className="col-md-4 col-md-offset-1 content-ct">
          ...
          <p>
            Lorem <a href="#">#Ipsum</a> is a dummy text used as a text filler in designs. This is just a dummy text. via{' '}
            <a href="#">@designerdada</a>{' '}
          </p>
          <hr />
          <p>
            Lorem Ipsum is a <a href="#">#dummy</a> text used as a text filler in designs. This is just a dummy text. via{' '}
            <a href="#">@designerdada</a>{' '}
          </p>
          <hr />
          <p>
      ...
      <div className="row footer-credit">
        <div className="col-md-6 col-sm-6">
          <p>
            &copy; 2015, <a href="http://www.designerdada.com">DesignerDada.com</a> | All rights reserved.
          </p>
        </div>
        <div className="col-md-6 col-sm-6">
