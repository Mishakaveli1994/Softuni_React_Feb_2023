  ...
  return (
    <div className="row me-row content-ct speaker" id="speakers">
      ...
      <div className="col-md-4 col-sm-6 feature">
        ...
        <h3>Simon Collins</h3>
        <p>
          Simon is designer and partner at Fictivekin and has worked in a variety of situations for bands, record labels, governments, polar
      ...
      <div className="col-md-4 col-sm-6 feature">
        ...
        <p>
          Stephie is a user experience researcher and designer. In over 15 years of working on the web, she has worn many hats, including a
      ...
      <div className="col-md-4 col-sm-6 feature">
        ...
        <h3>Harry Roberts</h3>
        <p>
          Harry is a freelance designer, developer, writer, speaker and front-end architect from the UK, previously working as Senior UI
