                ...
                <div className="col-md-6">
                  <div className="media">
                    ...
                    <div className="media-body">
                      ...
                      <p>
                        Simon is designer and partner at Fictivekin and has worked in a variety of situations for bands, record labels,
                        governments, polar explorers, and most other things.{' '}
                      </p>
                    </div>
                  </div>
                </div>
